...
urlpatterns = [
    ...
    path("materials/", views.materials_catalogs, name="materials_catalogs"),
    path("materials/<int:catalog>/", views.materials, name="materials"),
    path("materials/<int:catalog>/<int:id>/", views.materials, name="materials"),
    path("materials/<int:catalog>/<int:id>/view/", views.material, name="material"),
