...
def controlpanel_flows(request):
    ...
    if "load" in request.GET:
        flows = [
            ["BATIMENTS VERS ACTIVITE SUPPORT", 26],
            ["BATIMENTS VERS AEP", 24],
            ["BATIMENTS VERS EU", 25],
            ["DECHETS BATIMENTS ACTIVITE SUPPORT", 47],
            ["DECHETS BATIMENTS AEP", 45],
            ["DECHETS BATIMENTS EU", 46],
            ["DECHETS EQUIPEMENTS ELECTRIQUES ACTIVITE SUPPORT", 50],
            ["DECHETS EQUIPEMENTS ELECTRIQUES AEP", 48],
            ["DECHETS EQUIPEMENTS ELECTRIQUES EU", 49],
            ["DECHETS EQUIPEMENTS HYDRAULIQUES ACTIVITE SUPPORT", 44],
            ["DECHETS EQUIPEMENTS HYDRAULIQUES AEP", 42],
            ["DECHETS EQUIPEMENTS HYDRAULIQUES EU", 43],
            ["DECHETS EXPORTES BATIMENTS", 67],
            ["DECHETS EXPORTES EQUIPEMENTS ELECTRIQUES", 68],
            ["DECHETS EXPORTES EQUIPEMENTS HYDRAULIQUES", 66],
            ["DECHETS EXPORTES FOURNITURES", 70],
            ["DECHETS EXPORTES OUVRAGES", 64],
            ["DECHETS EXPORTES RESEAUX", 65],
            ["DECHETS EXPORTES VEHICULES", 69],
            ["DECHETS FOURNITURES ACTIVITE SUPPORT", 56],
            ["DECHETS FOURNITURES AEP", 54],
            ["DECHETS FOURNITURES EU", 55],
            ["DECHETS LOCAUX BATIMENTS", 60],
            ["DECHETS LOCAUX EQUIPEMENTS ELECTRIQUES", 61],
            ["DECHETS LOCAUX EQUIPEMENTS HYDRAULIQUES", 59],
            ["DECHETS LOCAUX FOURNITURES", 63],
            ["DECHETS LOCAUX OUVRAGES", 57],
            ["DECHETS LOCAUX RESEAUX", 58],
            ["DECHETS LOCAUX VEHICULES", 62],
            ["DECHETS OUVRAGE ACTIVITE SUPPORT", 38],
            ["DECHETS OUVRAGE AEP", 36],
            ["DECHETS OUVRAGE EU", 37],
            ["DECHETS RESEAUX ACTIVITE SUPPORT", 41],
            ["DECHETS RESEAUX AEP", 39],
            ["DECHETS RESEAUX EU", 40],
            ["DECHETS VEHICULES ACTIVITE SUPPORT", 53],
            ["DECHETS VEHICULES AEP", 51],
            ["DECHETS VEHICULES EU", 52],
            ["EQUIPEMENTS ELECTRIQUES VERS ACTIVITE SUPPORT", 29],
            ["EQUIPEMENTS ELECTRIQUES VERS AEP", 27],
            ["EQUIPEMENTS ELECTRIQUES VERS EU", 28],
            ["EQUIPEMENTS HYDRAULIQUES VERS ACTIVITE SUPPORT", 23],
            ["EQUIPEMENTS HYDRAULIQUES VERS AEP", 21],
            ["EQUIPEMENTS HYDRAULIQUES VERS EU", 22],
            ["EXTRACTION LOCALE BATIMENTS", 11],
            ["EXTRACTION LOCALE EQUIPEMENTS ELECTRIQUES", 12],
            ["EXTRACTION LOCALE EQUIPEMENTS HYDRAULIQUES", 10],
            ["EXTRACTION LOCALE FOURNITURES", 14],
            ["EXTRACTION LOCALE OUVRAGES", 8],
            ["EXTRACTION LOCALE RESEAUX", 9],
            ["EXTRACTION LOCALE VEHICULES", 13],
            ["FOURNITURES VERS ACTIVITE SUPPORT", 35],
            ["FOURNITURES VERS AEP", 33],
            ["FOURNITURES VERS EU", 34],
            ["IMPORTATION BATIMENTS", 4],
            ["IMPORTATION EQUIPEMENTS ELECTRIQUES", 5],
            ["IMPORTATION EQUIPEMENTS HYDRAULIQUES", 3],
            ["IMPORTATION FOURNITURES", 7],
            ["IMPORTATION OUVRAGES", 1],
            ["IMPORTATION RESEAUX", 2],
            ["IMPORTATION VEHICULES", 6],
            ["MATIERES SECONDAIRES", 71],
            ["OUVRAGE VERS ACTIVITE SUPPORT", 17],
            ["OUVRAGE VERS AEP", 15],
            ["OUVRAGE VERS EU", 16],
            ["RESEAUX VERS ACTIVITE SUPPORT", 20],
            ["RESEAUX VERS AEP", 18],
            ["RESEAUX VERS EU", 19],
            ["VEHICULES VERS ACTIVITE SUPPORT", 32],
            ["VEHICULES VERS AEP", 30],
            ["VEHICULES VERS EU", 31],
        ]
        for each in flows:
            WaterSystemFlow.objects.create(name=each[0], level=2, category_id=4, identifier=each[1])

    if "load2" in request.GET:
        flows = [
            ["DECHETS BATIMENTS ACTIVITE SUPPORT", 12],
            ["DECHETS BATIMENTS AEP", 10],
            ["DECHETS BATIMENTS EU", 11],
            ["DECHETS EQUIPEMENTS ELECTRIQUES ACTIVITE SUPPORT", 15],
            ["DECHETS EQUIPEMENTS ELECTRIQUES AEP", 13],
            ["DECHETS EQUIPEMENTS ELECTRIQUES EU", 14],
            ["DECHETS EQUIPEMENTS HYDRAULIQUES ACTIVITE SUPPORT", 9],
            ["DECHETS EQUIPEMENTS HYDRAULIQUES AEP", 7],
            ["DECHETS EQUIPEMENTS HYDRAULIQUES EU", 8],
            ["DECHETS FOURNITURES ACTIVITE SUPPORT", 21],
            ["DECHETS FOURNITURES AEP", 19],
            ["DECHETS FOURNITURES EU", 20],
            ["DECHETS LOCAUX BATIMENTS", 25],
            ["DECHETS LOCAUX EQUIPEMENTS ELECTRIQUES", 26],
            ["DECHETS LOCAUX EQUIPEMENTS HYDRAULIQUES", 24],
            ["DECHETS LOCAUX FOURNITURES", 28],
            ["DECHETS LOCAUX OUVRAGES", 22],
            ["DECHETS LOCAUX RESEAUX", 23],
            ["DECHETS LOCAUX VEHICULES", 27],
            ["DECHETS OUVRAGE ACTIVITE SUPPORT", 3],
            ["DECHETS OUVRAGE AEP", 1],
            ["DECHETS OUVRAGE EU", 2],
            ["DECHETS RESEAUX ACTIVITE SUPPORT", 6],
            ["DECHETS RESEAUX AEP", 4],
            ["DECHETS RESEAUX EU", 5],
            ["DECHETS VEHICULES ACTIVITE SUPPORT", 18],
            ["DECHETS VEHICULES AEP", 16],
            ["DECHETS VEHICULES EU", 17],
            ["MATIERES SECONDAIRES", 29],
            ["MATIERES SECONDAIRES BATIMENTS", 36],
            ["MATIERES SECONDAIRES BATIMENTS VERS ACTIVITE SUPPORT", 51],
            ["MATIERES SECONDAIRES BATIMENTS VERS AEP", 49],
            ["MATIERES SECONDAIRES BATIMENTS VERS EU", 50],
            ["MATIERES SECONDAIRES EQUIPEMENTS ELECTRIQUES", 37],
            ["MATIERES SECONDAIRES EQUIPEMENTS ELECTRIQUES VERS ACTIVITE SUPPORT", 54],
            ["MATIERES SECONDAIRES EQUIPEMENTS ELECTRIQUES VERS AEP", 52],
            ["MATIERES SECONDAIRES EQUIPEMENTS ELECTRIQUES VERS EU", 53],
            ["MATIERES SECONDAIRES EQUIPEMENTS HYDRAULIQUES", 35],
            ["MATIERES SECONDAIRES EQUIPEMENTS HYDRAULIQUES VERS ACTIVITE SUPPORT", 48],
            ["MATIERES SECONDAIRES EQUIPEMENTS HYDRAULIQUES VERS AEP", 46],
            ["MATIERES SECONDAIRES EQUIPEMENTS HYDRAULIQUES VERS EU", 47],
            ["MATIERES SECONDAIRES EXPORTEES", 30],
            ["MATIERES SECONDAIRES FOURNITURES", 39],
            ["MATIERES SECONDAIRES FOURNITURES VERS ACTIVITE SUPPORT", 60],
            ["MATIERES SECONDAIRES FOURNITURES VERS AEP", 58],
            ["MATIERES SECONDAIRES FOURNITURES VERS EU", 59],
            ["MATIERES SECONDAIRES MNCA", 31],
            ["MATIERES SECONDAIRES OUVRAGE VERS ACTIVITE SUPPORT", 42],
            ["MATIERES SECONDAIRES OUVRAGE VERS AEP", 40],
            ["MATIERES SECONDAIRES OUVRAGE VERS EU", 41],
            ["MATIERES SECONDAIRES OUVRAGES", 33],
            ["MATIERES SECONDAIRES REA", 32],
            ["MATIERES SECONDAIRES RESEAUX", 34],
            ["MATIERES SECONDAIRES RESEAUX VERS ACTIVITE SUPPORT", 45],
            ["MATIERES SECONDAIRES RESEAUX VERS AEP", 43],
            ["MATIERES SECONDAIRES RESEAUX VERS EU", 44],
            ["MATIERES SECONDAIRES VEHICULES", 38],
            ["MATIERES SECONDAIRES VEHICULES VERS ACTIVITE SUPPORT", 57],
            ["MATIERES SECONDAIRES VEHICULES VERS AEP", 55],
            ["MATIERES SECONDAIRES VEHICULES VERS EU", 56],
        ]
        for each in flows:
            WaterSystemFlow.objects.create(name=each[0], level=3, category_id=4, identifier=each[1])

    if "load3" in request.GET:
        flows = [
            ["GAZ A EFFET DE SERRE EVITES ACTIVITE SUPPORT (STEP)", "ACTIVITE SUPPORT", 33],
            ["GAZ A EFFET DE SERRE EVITES AEP (CAPTAGE + PRODUCTION)", "ACTIVITE EAU POTABLE", 29],
            ["GAZ A EFFET DE SERRE EVITES AEP (DISTRIBUTION)", "ACTIVITE EAU POTABLE", 30],
            ["GAZ A EFFET DE SERRE EVITES EU (RESEAUX)", "ACTIVITE ASSAINISSEMENT", 31],
            ["GAZ A EFFET DE SERRE EVITES EU (STEP)", "ACTIVITE ASSAINISSEMENT", 32],
            ["PRODUCTION D'AUTRES GES PAR L'AEP (CAPTAGE + PRODUCTION)", "ACTIVITE EAU POTABLE", 8],
            ["PRODUCTION D'AUTRES GES PAR L'AEP (DISTRIBUTION)", "ACTIVITE EAU POTABLE", 12],
            ["PRODUCTION D'AUTRES GES PAR L'EU (RESEAUX)", "ACTIVITE ASSAINISSEMENT", 16],
            ["PRODUCTION D'AUTRES GES PAR L'EU (STEP)", "ACTIVITE ASSAINISSEMENT", 20],
            ["PRODUCTION D'AUTRES GES PAR LES ACTIVITES SUPPORT", "ACTIVITE SUPPORT", 24],
            ["PRODUCTION DE CH4 PAR L'AEP (CAPTAGE + PRODUCTION)", "ACTIVITE EAU POTABLE", 6],
            ["PRODUCTION DE CH4 PAR L'AEP (DISTRIBUTION)", "ACTIVITE EAU POTABLE", 10],
            ["PRODUCTION DE CH4 PAR L'EU (RESEAUX)", "ACTIVITE ASSAINISSEMENT", 14],
            ["PRODUCTION DE CH4 PAR L'EU (STEP)", "ACTIVITE ASSAINISSEMENT", 18],
            ["PRODUCTION DE CH4 PAR LES ACTIVITES SUPPORT", "ACTIVITE SUPPORT", 22],
            ["PRODUCTION DE CO2 PAR L'AEP (CAPTAGE + PRODUCTION)", "ACTIVITE EAU POTABLE", 7],
            ["PRODUCTION DE CO2 PAR L'AEP (DISTRIBUTION)", "ACTIVITE EAU POTABLE", 11],
            ["PRODUCTION DE CO2 PAR L'EU (RESEAUX)", "ACTIVITE ASSAINISSEMENT", 15],
            ["PRODUCTION DE CO2 PAR L'EU (STEP)", "ACTIVITE ASSAINISSEMENT", 19],
            ["PRODUCTION DE CO2 PAR LES ACTIVITES SUPPORT", "ACTIVITE SUPPORT", 23],
            ["PRODUCTION DE N2O PAR L'AEP (CAPTAGE + PRODUCTION)", "ACTIVITE EAU POTABLE", 5],
            ["PRODUCTION DE N2O PAR L'AEP (DISTRIBUTION)", "ACTIVITE EAU POTABLE", 9],
            ["PRODUCTION DE N2O PAR L'EU (RESEAUX)", "ACTIVITE ASSAINISSEMENT", 13],
            ["PRODUCTION DE N2O PAR L'EU (STEP)", "ACTIVITE ASSAINISSEMENT", 17],
            ["PRODUCTION DE N2O PAR LES ACTIVITES SUPPORT", "ACTIVITE SUPPORT", 21],
            ["PRODUCTION TOTALE D'AUTRES GES", "", 28],
            ["PRODUCTION TOTALE DE CH4", "", 26],
            ["PRODUCTION TOTALE DE CO2", "", 27],
            ["PRODUCTION TOTALE DE N2O", "", 25],
        ]
        WaterSystemFlow.objects.filter(level=2, category_id=3).delete()
        for each in flows:
            d = each[1]
            if d == "":
                d = None
            WaterSystemFlow.objects.create(name=each[0], description=d, level=2, category_id=3, identifier=each[2])
