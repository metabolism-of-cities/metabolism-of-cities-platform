...
class Video(Record):
    ...
    def embed(self):
        if self.video_site == "youtube":
            ...
            return f'<iframe class="video-embed youtube-video" title="vimeo-player" src="https://player.vimeo.com/video/{self.embed_code}" frameborder="0" allowfullscreen></iframe>'
