...
urlpatterns = [
    ...
    path(
        ...
        auth_views.PasswordResetView.as_view(template_name="auth/reset.html", email_template_name="mailbody/password.reset.html",subject_template_name="mailbody/password.reset.txt", success_url="/accounts/passwordreset/sent/"), 
        name="password_reset", 
    ),
    path(  
