! function(e, t) {
    ...
    var t = L.MarkerClusterGroup = L.FeatureGroup.extend({
        ...
        _bindEvents: function() {
            ...
            (t || n || spiderfyOnEveryZoom) && this.on("clusterclick", this._zoomOrSpiderfy, this), i && (this.on("clustermouseover", this._showCoverage, this), this.on("clustermouseout", this._hideCoverage, this), e.on("zoomend", this._hideCoverage, this))
        },
        ...
        _unbindEvents: function() {
            var e = this.options.spiderfyOnMaxZoom,
                ...
                spiderfyOnEveryZoom = this.options.spiderfyOnEveryZoom,
                n = this._map;
            (e || i || spiderfyOnEveryZoom) && this.off("clusterclick", this._zoomOrSpiderfy, this), t && (this.off("clustermouseover", this._showCoverage, this), this.off("clustermouseout", this._hideCoverage, this), n.off("zoomend", this._hideCoverage, this))
        },
        _zoomEnd: function() {
